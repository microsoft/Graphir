...
public class ExtensionType : ObjectType<Extension>
{
    protected override void Configure(IObjectTypeDescriptor<Extension> descriptor)
    {
        ...
        descriptor.Field("valueCanonical").Resolve(r => DataTypeResolvers.GetCanonicalValue(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valueInteger64").Resolve(r => DataTypeResolvers.GetInteger64Value(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valuePositiveInt").Resolve(r => DataTypeResolvers.GetPositiveIntValue(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valueUnsignedInt").Resolve(r => DataTypeResolvers.GetUnsignedIntValue(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valueAnnotation").Resolve(r => DataTypeResolvers.GetValue<Annotation>(r.Parent<Extension>().Value));
        descriptor.Field("valueAttachment").Resolve(r => DataTypeResolvers.GetValue<Attachment>(r.Parent<Extension>().Value));
        descriptor.Field("valueCodeableConcept").Resolve(r => DataTypeResolvers.GetValue<CodeableConcept>(r.Parent<Extension>().Value));
        descriptor.Field("valueCoding").Resolve(r => DataTypeResolvers.GetValue<Coding>(r.Parent<Extension>().Value));
        descriptor.Field("valueContactPoint").Resolve(r => DataTypeResolvers.GetValue<ContactPoint>(r.Parent<Extension>().Value));
        descriptor.Field("valueCount").Resolve(r => DataTypeResolvers.GetValue<Count>(r.Parent<Extension>().Value));
        descriptor.Field("valueDistance").Resolve(r => DataTypeResolvers.GetValue<Distance>(r.Parent<Extension>().Value));
        descriptor.Field("valueDuration").Resolve(r => DataTypeResolvers.GetValue<Duration>(r.Parent<Extension>().Value));
        descriptor.Field("valueHumanName").Resolve(r => DataTypeResolvers.GetValue<HumanName>(r.Parent<Extension>().Value));
        descriptor.Field("valueIdentifier").Resolve(r => DataTypeResolvers.GetValue<Identifier>(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valueQuantity").Resolve(r => DataTypeResolvers.GetValue<Quantity>(r.Parent<Extension>().Value));
        ...
        descriptor.Field("valueSampledData").Resolve(r => DataTypeResolvers.GetValue<SampledData>(r.Parent<Extension>().Value));
        descriptor.Field("valueSignature").Resolve(r => DataTypeResolvers.GetValue<Signature>(r.Parent<Extension>().Value));
        descriptor.Field("valueTiming").Resolve(r => DataTypeResolvers.GetValue<Timing>(r.Parent<Extension>().Value));
        descriptor.Field("valueContactDetail").Resolve(r => DataTypeResolvers.GetValue<ContactDetail>(r.Parent<Extension>().Value));
        descriptor.Field("valueContributor").Resolve(r => DataTypeResolvers.GetValue<Contributor>(r.Parent<Extension>().Value));
        descriptor.Field("valueDataRequirement").Resolve(r => DataTypeResolvers.GetValue<DataRequirement>(r.Parent<Extension>().Value));
        descriptor.Field("valueExpression").Resolve(r => DataTypeResolvers.GetValue<Expression>(r.Parent<Extension>().Value));
        descriptor.Field("valueParameterDefinition").Resolve(r => DataTypeResolvers.GetValue<ParameterDefinition>(r.Parent<Extension>().Value));
        descriptor.Field("valueRelatedArtifact").Resolve(r => DataTypeResolvers.GetValue<RelatedArtifact>(r.Parent<Extension>().Value));
        descriptor.Field("valueTriggerDefinition").Resolve(r => DataTypeResolvers.GetValue<TriggerDefinition>(r.Parent<Extension>().Value));
