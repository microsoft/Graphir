...
namespace Graphir.API.Schema
{
    ...
    public class EndpointQuery : ObjectTypeExtension<Query>
    {
        protected override void Configure(IObjectTypeDescriptor<Query> descriptor)
        {
            descriptor.Field("Endpoint")
                ...
                .ResolveWith<ResourceResolvers<Endpoint>>(r => r.GetResource(default!, default!));

            descriptor.Field("EndpointList")
                .Type<ListType<EndpointType>>()
                .ResolveWith<ResourceResolvers<Endpoint>>(r => r.GetResources(default!));
        }
    }
    #endregion
}
